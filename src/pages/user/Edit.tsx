      ...
      <section className='h-full'>
        <div className='px-10 pb-32'>
          ...
          <form
            ...
            <div>
              <span className='font-semibold flex my-4 text-lg'>
            ...
            <div>
              ...
              <div className='space-y-2'>
                <input
                  ...
                  className='border border-gray rounded-full w-full h-12 px-4 mb-4'
            ...
            <div>
              <span className='font-semibold flex my-4 text-lg'>전화번호</span>
              <input
            ...
            <div>
              <span className='font-semibold flex my-4 text-lg'>연소득</span>
              <div className='flex items-center justify-between gap-2'>
                <input
                  className='border border-gray px-6 py-3 rounded-full w-full'
                  type='number'
                  placeholder={'1000 이상'}
                  {...register('salary', {
                    required: '필수입니다.',
