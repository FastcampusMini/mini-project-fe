  ...
  return (
    <div>
      ...
      <div className="mb-16">
        <form className="flex flex-wrap gap-3 rounded-[10px]">
          <div className="w-full sm:text-right text-left">
            <label htmlFor="check1" className="">내가 가입할 수 있는 상품만 보기</label>
          ...
          <div className="relative grow">
            <input type='text' required className="pl-4 pr-4 py-3 w-full h-full rounded-full border-2 border-light-gray bg-white overflow-hidden focus:outline-none focus-within:border-yellow focus-within:border-2 valid:border-2 valid:border-yellow" 
            placeholder="원하는 상품을 검색하세요" 
            defaultValue={''}
            onChange={(e) => setSearchName(e.target.value)} />
            <button className="absolute top-0 bottom-0 right-4 text-black40" type='submit'><CgSearch size='26'></CgSearch></button>
          </div>
      ...
      <div className="mb-16">        
        ...
        : 
        <div className="my-40 flex justify-center items-center text-black40 font-bold text-lg">등록된 상품이 없습니다.</div>
        }
      </div>
    </div>
  );
