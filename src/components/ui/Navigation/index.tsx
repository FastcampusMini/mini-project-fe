...
const index = () => {
  ...
  return (
    <div className='flex justify-around items-center text-4xl text-gray py-6 rounded-t-3xl border-t border-black/20 cursor-pointer bottom-0 absolute w-full left-0'>
